    ...
    <body>
        <header class="row">
            ...
            <div class="navegacion">
                ...
                <nav class="m">
                    <ul  class="menu">
                        <li><a href="index_intranet.php">Inicio</a></li>
        ...
        <div class="row">
            <div class="col-12 tail"><br/><br/>
                <h1 style="color: #b72a67; text-align: center;">Intranet Alumnos</h1><br/>
                <div style="text-align: center;"  class="col-12 col-m-12 col-s-12 imagen">
