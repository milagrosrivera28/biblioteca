    ...
    <body>
        ...
        <div class="row">
            <div class="col-12 tail"><br/><br/>
                <article>
                    <button type="a" >
                        <a href="login.html" style=" text-decoration: none; color: white;">Reservar Libro</a>  
                    </button> <br/><br/>
                    <h3 style="color: #F2EABC; text-align: center;">Registro de Libros</h3><br/>
...
<!--                        <th>ID</th>-->
                        ...
                        <tbody>
                            <?php
                            $registros = bd_consultar("SELECT * FROM libro_view");
                            if (!$registros) {
                                ?>
                                <tr> 
...
<!--                                        <td>
                                            <img src="mostrar_imagen.php?id=<?= $libro['idlibro']; ?>" height="50"/>
                                        </td>-->
